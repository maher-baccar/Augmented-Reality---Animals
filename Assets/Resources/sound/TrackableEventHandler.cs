...
using UnityEngine;
using Vuforia;
using UnityEngine.Events; //importer cette bib
/// <summary>
...
// changer le nom "DefaultTrackableEventHandler" vers "TrackableEventHandler"
{
#region PROTECTED_MEMBER_VARIABLES
public UnityEvent onTrack; /*********a ajouter *************/
public UnityEvent onLost; /*********a ajouter *************/
...
{
onTrack.Invoke();//lorsqu’on trouve l’image Target on lit le son
OnTrackingFound();
}
else if (previousStatus == TrackableBehaviour.Status.TRACKED &&
newStatus == TrackableBehaviour.Status.NO_POSE)
{
onLost.Invoke();//lorsqu’on perd l’image target
OnTrackingLost();
}
else
{
